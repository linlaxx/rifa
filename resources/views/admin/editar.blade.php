        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.editar', $rifa->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ej: Rifa de un iPhone 15" value="{{ old('nombre', $rifa->nombre) }}" required>
                    <div class="invalid-feedback">Por favor ingresa un nombre para la rifa.</div>
                </div>

                <div class="mb-3">
                    <label for="descripcion" class="form-label fw-bold">Descripción</label>
                    <textarea name="descripcion" id="descripcion" class="form-control" placeholder="Escribe una breve descripción..." rows="3">{{ old('descripcion', $rifa->descripcion) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="fotos" class="form-label fw-bold">Foto del premio</label>
                    <input type="file" name="fotos" id="fotos" class="form-control">
                    @if($rifa->fotos)
                        <small class="text-muted">Foto actual: <a href="{{ asset('storage/' . $rifa->fotos) }}" target="_blank">Ver</a></small>
                    @endif
                    <small class="text-muted d-block">Formatos permitidos: JPG, PNG.</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="precio_boleto" id="precio_boleto" class="form-control" step="0.01" placeholder="Ej: 50.00" value="{{ old('precio_boleto', $rifa->precio_boleto) }}" required>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="total_boletos" id="total_boletos" class="form-control" placeholder="Ej: 100" value="{{ old('total_boletos', $rifa->total_boletos) }}" required>
