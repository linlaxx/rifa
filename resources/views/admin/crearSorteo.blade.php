...
@section('content')
    <div class="container mt-4">
        <div class="card shadow-lg rounded">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.guardar') }}" method="POST" enctype="multipart/form-data"
                    class="needs-validation" novalidate>
                    @csrf

                    <div class="row">
                        {{-- Columna izquierda: datos del sorteo --}}
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="nombre" class="form-label fw-bold">Nombre del sorteo <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="nombre" id="nombre" class="form-control"
                                    placeholder="Ej: Sorteo de un iPhone 15" value="{{ old('nombre') }}" required>
                            ...
                            <div class="mb-3">
                                <label for="precio_boleto" class="form-label fw-bold">Precio por boleto <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">💵</span>
                                    <input type="number" name="precio_boleto" id="precio_boleto" class="form-control"
                                        step="0.01" placeholder="Ej: 50.00" value="{{ old('precio_boleto') }}" required>
                                </div>
                                <div class="invalid-feedback">Por favor ingresa un precio válido.</div>
                            </div>

                            <div class="mb-3">
                                <label for="total_boletos" class="form-label fw-bold">Total de boletos <span
                                        class="text-danger">*</span></label>
                                <input type="number" name="total_boletos" id="total_boletos" class="form-control"
                                    placeholder="Ej: 100" value="{{ old('total_boletos') }}" required>
                                <div class="invalid-feedback">Por favor ingresa el total de boletos.</div>
                            </div>

                            <div class="mb-3">
                                <label for="fecha_sorteo" class="form-label fw-bold">Fecha y hora del sorteo <span
                                        class="text-danger">*</span></label>
                                <input type="datetime-local" name="fecha_sorteo" id="fecha_sorteo" class="form-control"
                                    value="{{ old('fecha_sorteo') }}" required>
                                <div class="invalid-feedback">Por favor selecciona la fecha y hora del sorteo.</div>
                            </div>
                        </div>

                        {{-- Columna derecha: fotos del premio --}}
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Puedes subir de 1 a 3 imágenes. Formatos: JPG, PNG. Máx: 2MB
                                    c/u.</small>
    ...
    <script>
        ...
        // ================================
        // Restringir fecha y hora a futuro
        // ================================
        const fechaSorteoInput = document.getElementById('fecha_sorteo');
        const ahora = new Date();

        // Formatear fecha y hora al formato YYYY-MM-DDTHH:MM
        ...
        fechaSorteoInput.min = `${year}-${month}-${day}T${hours}:${minutes}`;
    </script>
@endsection